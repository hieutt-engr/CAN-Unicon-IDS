...
def parse_option():
    ...
    opt.save_folder = './save/CAN-ML_models/Transferred/EfficentNet/' + opt.save_path + '/' + opt.version
    return opt
...
def set_model(opt):
    ...
    #Efficent-net: 158
    checkpoint_path = os.path.join(opt.trained_model_path, 'ckpt_epoch_158.pth')
